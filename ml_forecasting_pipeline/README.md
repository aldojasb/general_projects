...
│
├── pyproject.toml     <- Project configuration file with package metadata for ml/forecasting/pipeline
│                         and configuration for tools like black
│
└── src/ml/forecasting/pipeline <- Source code for use in this project.
    │
